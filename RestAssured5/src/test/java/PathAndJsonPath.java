...
public class PathAndJsonPath {
    ...
    public void getZipCode(){
        ...
        Response response =
                ...
                ;
        Location locPathAs = response.as(Location.class); // Bütün class ları yazmak zorundasın
        System.out.println("locPathAs.getPlaces() = " + locPathAs.getPlaces());

        List<Place> places = response.jsonPath().getList("places", Place.class); // Nokta atışı istediğini alabilirsin
